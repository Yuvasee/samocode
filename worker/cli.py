"""Samocode CLI: orchestrator loop plus install/approve/recover commands.

Lives inside the package so an editable install runs the checkout's code and
assets; a top-level module would be copied into site-packages and go stale.
"""
