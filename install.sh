...
echo "============================================================"
echo ""
echo "For each project where you use samocode, add this to CLAUDE.md:"
echo ""
echo "  ## Project Paths"
echo ""
echo "  These paths are used by samocode:"
echo ""
echo "  - **MAIN_REPO**: \`~/your-project/repo\`"
echo "  - **WORKTREES**: \`~/your-project/worktrees/\`"
echo "  - **SESSIONS**: \`~/your-project/_sessions/\`"
echo ""
echo "Without these paths, samocode will refuse to run."
echo ""
echo "============================================================"
echo ""
